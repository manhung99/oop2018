...
public class Task1 {
    ...
    public static String findFunctionByName(String name) throws IOException {
        BufferedReader in = new BufferedReader(new FileReader("D:\\Documents\\Java\\oop2018\\src\\week9\\Utils.java"));
        String line;
        String value = ""; // name of function
    ...
    public static void main(String[] args) throws IOException {
        String path = "D:\\Documents\\Java\\oop2018\\src\\week9\\Utils.java";
        File file = new File(path);
        List<String> allFunctions = getAllFunctions(file);
        //System.out.println(allFunctions.get(2));
